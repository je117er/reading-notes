...
\*\*"inconsistency" is probably not the accurate word here, because the positive side of econ doesn't concern with judgment (unlike the normative one), but only attempts to explain the way things are as best as it can. "variation" would've been a more neutral alterative, but "inconsistency" will be kept because it fully captures notetaker's frustration and precision maximization isn't the main objective of this note.